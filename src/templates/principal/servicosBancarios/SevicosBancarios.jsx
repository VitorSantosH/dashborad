        ...
        <div className="servicosBancarios">
            <div className="div1">
                ...
                <div className="realizarPix">
                    ...
                    <span className="pixLabel" value='3' onClick={e => marcar(e.target.attributes.value)}>
                        Realizar PIX
                    </span>

                </div>

                <div className="pagarContas">
                    ...
                    <span value='4' className='pagarLabel' onClick={e => marcar(e.target.attributes.value)}> Pagar Contas</span>
